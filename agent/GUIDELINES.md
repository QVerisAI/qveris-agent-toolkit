...
When using the QVeris CLI (`@qverisai/cli` v0.11.0) instead of MCP, optimize for the same shortest safe path. Discover and Call are the default flow; Inspect and Probe are conditional checks, not required stages.
