...
export interface paths {
    "/agent/anonymous-register": {
        ...
        /**
         * Agent Anonymous Register
         * @description Create an anonymous trial agent without email verification.
         *
         *     Returns a one-time API key, the configured trial credits, and a claim code
         *     that the agent's operator can use to bind a formal email later.
         */
        post: operations["agent_anonymous_register_api_v1_agent_anonymous_register_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/agent/claim": {
        ...
        /**
         * Agent Claim Start
         * @description Bind a formal email to an anonymous trial and send a 6-digit code.
         */
        post: operations["agent_claim_start_api_v1_agent_claim_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/agent/claim-verify": {
        ...
        /**
         * Agent Claim Verify
         * @description Verify the emailed code and convert the anonymous trial to a local account.
         */
        post: operations["agent_claim_verify_api_v1_agent_claim_verify_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/oauth/credits_ledger": {
        ...
        /**
         * Oauth Credits Ledger
         * @description Requires an Account Resource access token with the `credits_ledger` scope.
         */
        get: operations["oauth_credits_ledger_api_v1_oauth_credits_ledger_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/oauth/usage_history": {
        ...
        /**
         * Oauth Usage History
         * @description Requires an Account Resource access token with the `usage_history` scope.
         */
        get: operations["oauth_usage_history_api_v1_oauth_usage_history_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/tools/by-ids": {
         ...
         * @description Fetch full capability metadata for one or more tool ids. Inspect is free and returns the same capability shape as Discover, including parameter schema, verification evidence, provider access restrictions, examples, quality signals, and cost estimates. Clients must disclose restrictions before Call.
         */
    ...
    "/tools/executions/by-idempotency-key": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /**
         * Reconcile Tool Execution
         * @description Read a prior paid execution without authorizing another provider call.
         */
        get: operations["reconcile_tool_execution_api_v1_tools_executions_by_idempotency_key_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
...
export interface components {
    schemas: {
        /** APIResponse[AgentAnonymousRegisterResponse] */
        APIResponse_AgentAnonymousRegisterResponse_: {
            /** Status */
            status: string;
            /** Message */
            message: string;
             ...
             */
            status_code: number;
            data?: components["schemas"]["AgentAnonymousRegisterResponse"] | null;
            /** Message Key */
            message_key?: string | null;
        };
        /** APIResponse[AgentClaimVerifyResponse] */
        APIResponse_AgentClaimVerifyResponse_: {
            /** Status */
            status: string;
            /** Message */
            message: string;
             ...
             */
            status_code: number;
            data?: components["schemas"]["AgentClaimVerifyResponse"] | null;
            /** Message Key */
            message_key?: string | null;
        };
        ...
        /** APIResponse[ToolExecutionReconciliationData] */
        APIResponse_ToolExecutionReconciliationData_: {
            /** Status */
            status: string;
            /** Message */
            message: string;
             ...
             */
            status_code: number;
            data?: components["schemas"]["ToolExecutionReconciliationData"] | null;
            /** Message Key */
            message_key?: string | null;
        };
        /** APIResponse[Union[AgentClaimStartResponse, AgentClaimRiskBlockResponse]] */
        APIResponse_Union_AgentClaimStartResponse__AgentClaimRiskBlockResponse__: {
            /** Status */
            status: string;
            /** Message */
            message: string;
            ...
            status_code: number;
            /** Data */
            data?: components["schemas"]["AgentClaimStartResponse"] | components["schemas"]["AgentClaimRiskBlockResponse"] | null;
            /** Message Key */
            message_key?: string | null;
        };
        ...
        /** AgentAnonymousRegisterResponse */
        AgentAnonymousRegisterResponse: {
            /** Agent Id */
            agent_id: string;
            /** Agent Name */
        ...
        /** AgentClaimRiskBlockResponse */
        AgentClaimRiskBlockResponse: {
            /**
             * Reason
             * @constant
             */
            reason: "email_risk_blocked";
        };
        /** AgentClaimStartRequest */
        AgentClaimStartRequest: {
            /** Claim Code */
            claim_code: string;
            /**
        ...
        /** AgentClaimStartResponse */
        AgentClaimStartResponse: {
            /** Email */
            email: string;
        };
        /** AgentClaimVerifyRequest */
        AgentClaimVerifyRequest: {
            /** Claim Code */
            claim_code: string;
            /**
        ...
        /**
         * AnonymousTrialMetadata
         * @description Machine-readable discovery metadata for the anonymous agent trial.
         */
        AnonymousTrialMetadata: {
            /**
             * Available
            ...
            /**
             * Register Path
             * @default /api/v1/agent/anonymous-register
             */
            register_path: string;
            /**
             * Claim Path
             * @default /api/v1/agent/claim
             */
            claim_path: string;
            /**
             * Claim Verify Path
             * @default /api/v1/agent/claim-verify
             */
            claim_verify_path: string;
            /**
             * Trial Credits
            ...
            /**
             * Instructions
             * @default If no human-verified API key is available, POST to register_path to obtain a one-time api_key and claim_code. Save both. Claim the trial later with claim_path and claim_verify_path.
             */
            instructions: string;
        };
        /** CreditsLedgerItem */
        ...
        PublicApiMetadata: {
            ...
            registration?: components["schemas"]["AnonymousTrialMetadata"];
        };
        ...
        /**
         * ToolExecutionReconciliationData
         * @description Durable state returned for one caller-scoped execution key.
         */
        ToolExecutionReconciliationData: {
            /**
             * Status
            ...
            provider_request_dispatched: boolean;
             ...
             * @enum {string}
             */
            retry_disposition: "terminal" | "reconcile_first";
            /** Response */
            response?: {
                [key: string]: unknown;
            } | null;
        ...
        UsageEventItem: {
            /** Anomalies */
            anomalies?: ("failed_charged_review" | "missing_ledger_link" | "missing_billing_snapshot")[] | null;
            /** Id */
            id: string;
            /** Event Type */
            event_type: string;
            ...
            oauth_client?: components["schemas"]["UsageEventOAuthClient"] | null;
            /**
             * Credential Attribution Status
             * @default historical_unknown
             * @enum {string}
             */
            credential_attribution_status: "api_key" | "oauth_client" | "user_session" | "non_api_key" | "historical_unknown";
            /** Session Id */
        ...
        PublicCapabilityDetailResponse: {
            ...
            schema_hash?: string;
            /** @enum {string} */
            verification_status: "unverified" | "verifying" | "verified" | "stale" | "failed" | "restricted";
            verification: components["schemas"]["PublicCatalogVerification"];
            execution_restrictions: components["schemas"]["PublicExecutionRestrictions"];
            remaining_credits?: number | null;
        } & {
            [key: string]: unknown;
        };
        ...
        PublicToolProbeResponse: {
            ...
            status?: number;
            /** @enum {string} */
            reason?: "tool_unavailable" | "tool_disabled" | "realtime_unavailable" | "region_restricted" | "insufficient_scope" | "delegation_budget_not_supported" | "oauth2_signin_required";
            ...
            recovery: components["schemas"]["PublicProbeRecoveryAdvice"];
            /** @enum {string} */
            verification_status: "unverified" | "verifying" | "verified" | "stale" | "failed" | "restricted";
            verification: components["schemas"]["PublicCatalogVerification"];
            execution_restrictions: components["schemas"]["PublicExecutionRestrictions"];
        ...
        PublicExecuteToolRequest: {
            ...
            sub_user_id?: string;
            /** @description Model that selected the capability or generated its parameters. */
            model?: string;
        ...
        PublicVerificationCheck: {
            /** @enum {string} */
            name: "schema" | "authentication" | "description_contract" | "provider_identity" | "permissions" | "freshness" | "live_check";
            /** @enum {string} */
        ...
        /**
         * PublicCatalogVerification
         * @description Fail-closed catalog verification result. Only records with every required check passed, a valid test digest, and an unexpired 24-hour evidence window are verified.
         */
        PublicCatalogVerification: {
            /** @enum {string} */
            status: "unverified" | "verifying" | "verified" | "stale" | "failed" | "restricted";
            policy_version: string;
            required_checks: string[];
            checks: components["schemas"]["PublicVerificationCheck"][];
            verified_at?: string | null;
            expires_at?: string | null;
            test_run_digest?: string | null;
            quality_issues: string[];
        } & unknown;
        /** PublicRegionRestrictions */
        PublicRegionRestrictions: {
            allow: string[];
            deny: string[];
        };
        ...
        PublicExecutionRestrictions: {
            ...
            regions: components["schemas"]["PublicRegionRestrictions"];
            /** @enum {string} */
...
export interface operations {
    agent_anonymous_register_api_v1_agent_anonymous_register_post: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["AgentAnonymousRegisterRequest"];
            };
        };
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["APIResponse_AgentAnonymousRegisterResponse_"];
                };
            };
    ...
    agent_claim_start_api_v1_agent_claim_post: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["AgentClaimStartRequest"];
            };
        };
        responses: {
            /** @description Successful Response */
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["APIResponse_Union_AgentClaimStartResponse__AgentClaimRiskBlockResponse__"];
                };
            };
            /** @description Validation Error */
            422: {
    ...
    agent_claim_verify_api_v1_agent_claim_verify_post: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["AgentClaimVerifyRequest"];
            };
        };
        responses: {
            /** @description Successful Response */
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["APIResponse_AgentClaimVerifyResponse_"];
                };
            };
            /** @description Validation Error */
            422: {
    ...
    get_usage_history_v2_api_v1_auth_usage_history_v2_get: {
        parameters: {
            query?: {
                ...
                /** @description OAuth client_id 归因过滤 */
    ...
    oauth_credits_ledger_api_v1_oauth_credits_ledger_get: {
        parameters: {
            query?: {
                /** @description 开始日期 (YYYY-MM-DD) */
                start_date?: string | null;
    ...
    oauth_usage_history_api_v1_oauth_usage_history_get: {
        parameters: {
            query?: {
                /** @description 开始日期 (YYYY-MM-DD) */
                start_date?: string | null;
    ...
    execute_api_v1_tools_execute_post: {
        parameters: {
            ...
            header?: {
                ...
                /** @description Caller-generated key used to reconcile uncertain execution outcomes */
        ...
        responses: {
            ...
            /** @description Idempotency key already exists, conflicts, or cannot be honored by the selected settlement path */
            409: {
                headers: {
                    /** @description Version of the published QVeris REST API contract. */
                    "X-Qveris-Api-Version": "2026-09-21.1";
            ...
            /** @description Explicit full response exceeds the platform safety limit */
            413: {
                headers: {
                    /** @description Version of the published QVeris REST API contract. */
                    "X-Qveris-Api-Version": "2026-09-21.1";
            ...
            /** @description Upstream result delivery violated the public contract */
            502: {
                headers: {
                    /** @description Version of the published QVeris REST API contract. */
                    "X-Qveris-Api-Version": "2026-09-21.1";
    ...
    reconcile_tool_execution_api_v1_tools_executions_by_idempotency_key_get: {
        parameters: {
            query: {
                /** @description Original Idempotency-Key value */
                key: string;
            };
            header?: never;
            path?: never;
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["APIResponse_ToolExecutionReconciliationData_"];
                };
            };
            /** @description Unauthorized */
            401: {
