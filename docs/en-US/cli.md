...
`@qverisai/cli` v0.10.0 is the latest tested release. It includes OAuth Device Flow sessions, zero-cost parameter/quote probes, and opt-in discovery and call projections while preserving API key compatibility.
